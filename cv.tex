  ...
  \resumeSubHeadingListStart
   ...
   \resumeSubheading
    ...
    \resumeSubheading
    	...
    	\vspace{0.25em}
    	Developed a novel system to visualize the cloud service cost of each customer on each feature. Used Google Cloud Storage and Looker Studio for visualization. Tested and deployed to production environment. Developed in collaboration with the team's Scrum process. Cooperate with QA engineers to ensure the quality of system.
...
\resumeSubHeadingListStart
\setlength\itemsep{0.25em}
\resumeSubItem{Marconix Award of 19th Marconix Science Award}{Top award in Macronix Science Award. The only recipient wthin 6 years.}
%\vspace{0.5pt}
