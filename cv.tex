  ...
  \resumeSubHeadingListStart
   ...
   \resumeSubheading
    ...
    \resumeSubheading
    	...
    	\vspace{0.25em}
    	Developed a novel system to calculate and visualize the cloud service costs for each customer per feature. Utilized Google Cloud Storage and Looker Studio for visualization. Tested and deployed the system in a production environment. Developed in collaboration with the team's Scrum process. Also engaged with Product Managers and sales teams to ensure the system meets their expectations.
...
\resumeSubHeadingListStart
\setlength\itemsep{0.25em}
\resumeSubItem{Marconix Award of 19th Marconix Science Award}{Top award in Macronix Science Award. The only recipient wthin 10 years.}
%\vspace{0.5pt}
