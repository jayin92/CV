...
\vspace{0.5pt}
\resumeSubItem{Fundamental Course Award of Introduction to Algorithms}{Second place out of 121 students.}
...
\section{Extracurricular Activities}
  \resumeSubHeadingListStart
    ...
    Led 120 members from various of departments in NYCU to organized welcoming camp, campus tour for over 50 students from Taoyaun, Yunlin and Chiayi. 
\vspace{1pt}
    \resumeSubheading
    ...
    Organized events and review agendas at SITCON (the largest student information conference in East Asia), also responsible for organizing the forum that discusses the issues of information education in Taiwan.
    \vspace{1pt}
    \resumeSubheading
